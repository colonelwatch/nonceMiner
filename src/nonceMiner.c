...
#define __PYX_HAVE__nonceMiner
#define __PYX_HAVE_API__nonceMiner
/* Early includes */
...
/* Module declarations from 'nonceMiner' */
#define __Pyx_MODULE_NAME "nonceMiner"
extern int __pyx_module_is_main_nonceMiner;
int __pyx_module_is_main_nonceMiner = 0;

/* Implementation of 'nonceMiner' */
...
/* Python wrapper */
static PyObject *__pyx_pw_10nonceMiner_1c_mine_DUCO_S1(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_10nonceMiner_1c_mine_DUCO_S1 = {"c_mine_DUCO_S1", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_10nonceMiner_1c_mine_DUCO_S1, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_10nonceMiner_1c_mine_DUCO_S1(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
...
static int __pyx_pymod_exec_nonceMiner(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_nonceMiner},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_src_nonceMiner_pyx, __pyx_k_src_nonceMiner_pyx, sizeof(__pyx_k_src_nonceMiner_pyx), 0, 0, 1, 0},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initnonceMiner(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initnonceMiner(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_nonceMiner(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_nonceMiner(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_nonceMiner(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'nonceMiner' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_nonceMiner(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("nonceMiner", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_nonceMiner) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "nonceMiner")) {
      if (unlikely(PyDict_SetItemString(modules, "nonceMiner", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init nonceMiner", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init nonceMiner");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
